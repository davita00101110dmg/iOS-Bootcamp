...
class ViewController: UIViewController {
    ...
    func decisionText() {
        ...
        case "average":
            finalLabel.text = "The average of these 3 random numbers is \(round((Double(firstRandomNumberValue) + Double(secondRandomNumberValue) + Double(thirdRandomNumberValue)) / 3 * 1000) / 1000)"
        case "sum":
